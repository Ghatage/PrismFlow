const SYSTEM_PROMPT = [
  ...
  'or a single clip id for a fade to/from black at a free edge. Besides the built-in transition',
  'types, the project may contain custom AI-generated transitions; their keys are accepted too.',
